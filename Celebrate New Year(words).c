...
int main()
{
    ...
    puts("\n\n亲爱的计安的小伙伴们:\n");
    puts("\t新春快乐!\n");
    s[6] = '4';// background color, 4--red

    //输出要说的话
    for (int i = 0; i < LINE; i++)// Print words 
    {
